...
public class ExportAssessmentListener implements ActionListener
{
 ...
 getRemoteAddr();
    	log.warn("Unauthorized attempt to access /samigo/jsf/qti/exportAssessment.xml?exportAssessmentId=" +  assessmentId + " from IP : " + thisIp);   // logging IP , as requested in SAK-17984
    	return;
    }
