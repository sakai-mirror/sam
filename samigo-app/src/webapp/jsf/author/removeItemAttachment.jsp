...
-->
 ...
 <h:form>
   ...
   <p class="act">
      <h:commandButton id="remove" accesskey="#{authorMessages.remove_attachment}" type="submit" value="#{authorMessages.button_remove}" action="#{itemauthor.getOutcome}" styleClass="active">
