  ...
  public List getExportResponsesData(String publishedAssessmentId, boolean anonymous, String audioMessage, String fileUploadMessage, String noSubmissionMessage, boolean showPartAndTotalScoreSpreadsheetColumns, String poolString, String sectionString, String questionString, String textString, String rationaleString, Map useridMap) {
	  List list = null;
	    try {
	        ...
	        getAssessmentGradingFacadeQueries().getExportResponsesData(publishedAssessmentId, anonymous,audioMessage, fileUploadMessage, noSubmissionMessage, showPartAndTotalScoreSpreadsheetColumns, poolString, sectionString, questionString, textString, rationaleString, useridMap);
	    } catch (Exception e) {
	      e.printStackTrace();
	    }
	    return list;
