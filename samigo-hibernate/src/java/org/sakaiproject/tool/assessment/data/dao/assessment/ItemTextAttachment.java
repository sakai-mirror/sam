...
public class ItemTextAttachment
...
private ItemTextIfc itemText;
  ...
  public ItemTextAttachment(Long attachmentId, ItemTextIfc itemText, String resourceId,
  ...
  public ItemTextAttachment(Long attachmentId, String resourceId,
                   String filename, String mimeType,
                   Long fileSize, String description, String location,
                   Boolean isLink, Integer status, String createdBy, Date createdDate,
                   String lastModifiedBy, Date lastModifiedDate){
