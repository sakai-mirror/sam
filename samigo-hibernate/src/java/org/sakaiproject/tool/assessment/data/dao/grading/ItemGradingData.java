...
public int hashCode() {
	...
	result = prime * result
			+ ((assessmentGrading == null) ? 0 : assessmentGrading.hashCode());
	result = prime * result
			+ ((attemptsRemaining == null) ? 0 : attemptsRemaining.hashCode());
	result = prime * result + ((autoScore == null) ? 0 : autoScore.hashCode());
	...
	result = prime * result
			+ ((publishedAnswer == null) ? 0 : publishedAnswer.hashCode());
	result = prime * result
			+ ((publishedAnswerId == null) ? 0 : publishedAnswerId.hashCode());
	result = prime * result
...
public boolean equals(Object obj) {
	...
	if (itemGradingAttachmentSet == null) {
		if (other.itemGradingAttachmentSet != null)
			return false;
	} else if (!itemGradingAttachmentSet.equals(other.itemGradingAttachmentSet))
		return false;
	...
	if (publishedAnswer == null) {
		if (other.publishedAnswer != null)
			return false;
	} else if (!publishedAnswer.equals(other.publishedAnswer))
		return false;
