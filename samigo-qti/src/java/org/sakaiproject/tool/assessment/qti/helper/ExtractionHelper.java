...
//      data.setSecuredIPAddressSet(securedIPAddressSet);
  ...
  public void updateItem(ItemFacade item, Item itemXml, boolean isRespondus)
  {
    ...
    {
    	addExtendedMatchingItemsTextAndAnswers(item, itemMap, itemXml);
    }
    else
    {
    	if (isRespondus) {
...
//          score = getCorrectScore(item, targetList.size());
  ...
  //------------- EMI -------------------//
	...
	private void addExtendedMatchingItemsTextAndAnswers(ItemFacade item,
			Map itemMap, Item itemXml) {
...
//				getList(itemMap, "richOptionAttach")));
		...
		itemTextSet.add(new ItemText((ItemData) item.getData(),
				...
				null));
		// score
		item.setScore(Float.valueOf(get(itemMap, "score")));
		item.setDiscount(Float.valueOf(get(itemMap, "discount")));
		// items
...
//			List<String> imageList, List<String> audioList, List<String> videoList, 
			List<String> attachList) {
		//XXX
//		if((imageList == null || imageList.isEmpty()) &&
//				(audioList == null || audioList.isEmpty()) &&
//				(videoList == null || videoList.isEmpty()) &&
//				(appList == null || appList.isEmpty())){
//			return null;
//		}
//		List<String> attachList = new ArrayList<String>();
//		if(imageList != null && !imageList.isEmpty()){
//			attachList.addAll(imageList);
//		}
//		if(audioList != null && !audioList.isEmpty()){
//			attachList.addAll(audioList);
//		}
//		if(videoList != null && !videoList.isEmpty()){
//			attachList.addAll(videoList);
//		}
//		if(appList != null && !appList.isEmpty()){
//			attachList.addAll(appList);
//		}
